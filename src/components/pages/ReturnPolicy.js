...
<div style={containerStyle} className="container returnContainer">
    <div className="row">
        <div className="md-col">
            <h4 style={returnPolicyInfo} className="return-policy">The kushery's policy is to only allow mechanical returns and exchanges.</h4>
            <ul>
           ...
           <p style={returnPolicyInfo} className="lead">**We will process your return and refund you the total cash ammount due, or you can choose to make another purchase.</p>
